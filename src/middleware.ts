...
export const config = {
  ...
  matcher: [
    "/((?!api/stripe/webhook|api/cron|api/health|api/stream-check|sw.js|offline.html|manifest.webmanifest|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
